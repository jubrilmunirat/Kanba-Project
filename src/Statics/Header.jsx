    ...
    <div className="flex justify-between items-center py-4 px-4 font-bold text-base md:text-xl top-0 left-0 z-50 h-[70px] gap-2 max-lg:px-2 max-lg:text-sm">
      <div className="flex justify-between gap-6 items-center cursor-pointer ">
        ...
        >
          <div className="p-4 flex flex-col gap-3 justify-center items-start w-full">
            ...
            <Link to="/tasks" onClick={() => setOpenMenu(false)}><nav>Tasks Board</nav></Link>
            ...
            <div className="w-full mt-2 border-t pt-3">
              ...
              >
                Category: <ChevronDown className={`w-4 h-4 transition ${openCategory ? "rotate-180" : ""}`} />
              </button>
        ...
        <div className="flex gap-6 items-center cursor-pointer max-md:hidden ">
          ...
          <Link to="/tasks" className="bg-white-500 hover:bg-[#800000] text-black font-bold py-2 px-4 rounded">Tasks Board</Link>
        </div>
      </div>
      ...
      <div className="flex justify-between gap-6 cursor-pointer ">
        ...
        <div className="flex gap-5 cursor-pointer max-md:hidden">
          <Link to="/signup" className="bg-[#800000] text-white px-5 py-2 rounded-lg">Sign-Up</Link>
          <Link to="/login" className="bg-[#800000] text-white px-5 py-2 rounded-lg">Log-in</Link>
        </div>
      </div>
	...
	return (
		<div className='flex justify-between  items-center py-4 px-4 font-bold text-base md:text-xl top-0 left-0 z-50 h-[70px] gap-2 max-lg:px-2 max-lg:text-sm'>
			<div className='flex justify-between gap-6 items-center cursor-pointer '>
				...
				<div
					className={`fixed top-0 left-0 w-[80%] max-w-[300px] h-screen flex flex-col items-start  gap-4 font-semibold text-lg  z-[60] transition-all duration-300 ease-in-out ${
						openMenu
				...
				<div className='flex gap-6 items-center cursor-pointer max-md:hidden '>
					<Link
						to='/'
						className='bg-white-500  hover:bg-[#800000] hover:text-white text-black font-bold py-2 px-4 rounded-full'
					>
						Home
					</Link>
					<Link
			...
			<div className='flex justify-between gap-6 cursor-pointer '>
				<button onClick={() => setOpenBin(true)} className='cursor-pointer'>
					<Trash className='hover:bg-[#800000] rounded-2xl py-2 h-10 w-10 hover:text-white' />
				</button>
				{/* <Trash className=" hover:bg-[#800000]  py-2 h-10 " /> */}
				<div className='flex gap-5 cursor-pointer max-md:hidden'>
					<Link
						...
						className='hover:bg-[#800000] hover:text-white px-5 py-2 rounded-full'
					>
						Sign-Up
					</Link>
					<Link
...
>>>>>>> 3cf6e527b1db358d688b89bd1d3d35219fbb580d
};
